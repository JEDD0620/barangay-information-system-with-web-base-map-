            ...
            <Form onSubmit={onAction}>
                    ...
                    <Row>
                        <Col md={12}>
                            <Form.Group className="mb-3">
                                ...
                                <Form.Control type="text" name='title' placeholder="input announcement title ..." required onChange={handleChange} />
                            </Form.Group>
                        </Col>
                    </Row>
                ...
                <Modal.Footer>
                    ...
                    <Button variant="primary" type='submit' disabled={loading}>
                        {loading ? <Spinner animation="border" size='sm' variant="light" /> : 'Create Announcement'}
                    </Button>
                </Modal.Footer>
            </Form>
            ...
            <Form onSubmit={onAction}>
                <Modal.Body>
                    <Row>
                        <Col md={12}>
                            <Form.Group className="mb-3">
                                <Form.Label>Title</Form.Label>
                                <Form.Control defaultValue={data.title} type="text" name='title' placeholder="input announcement title ..." required onChange={handleChange} />
                            </Form.Group>
                        </Col>
                    </Row>
                ...
                <Modal.Footer>
                    ...
                    <Button variant="warning" type='submit' disabled={loading}>
                        {loading ? <Spinner animation="border" size='sm' variant="light" /> : 'Edit Announcement'}
                    </Button>
                </Modal.Footer>
            </Form>
        ...
        <Modal show={!!data} onHide={handleClose} size='lg'>
            ...
            <Modal.Body>
                ...
                <Row className='text-center'>
                    <Col md={12}>
                        <h6>
                            {`Starting ${moment(data.from_date).format('D MMM YYYY')}${!!data.to_date ? ` to ${moment(data.to_date).format('D MMM YYYY')}` : ''}`}
                        </h6>
                        {!!data.from_time &&
                            <span>
